...
static void printSearchMessage(const struct Student* student)
{
    ...
    {
        printf("Good result. Keep working consistently.\n");
    }
    ...
    {
        printf("Mixed result. Review the record carefully.\n");
    }
}
...
int main(void)
{
    ...
    do
    {
        ...
        printf("3. Update progress by ID\n");
        printf("4. Search record\n");
        printf("5. Show ranking by progress\n");
        printf("6. Exit\n");
